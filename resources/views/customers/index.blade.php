...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="box-title">Data Product Users</h3>
        </div>

        <div class="box-header">
            <a href="{{ route('customers.create') }}" class="btn btn-primary" >Add Product Users</a>
        ...
        <div class="box-header">
            <div style="max-width: 30%;" class="pull-right">
                <form action="{{ url('/cari/customers') }}" method="get" class="input-group">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <p> {{ "Showing ". $customers->count() . " from " . $customers->firstItem() . " to " .  $customers->lastItem() ." of " . $customers->total() . " results "}}</p>
            <table id="customer-table" class="table table-striped">
                ...
                <tbody>
                @php
                    $i = 1 + $customers->currentPage() * $customers->perPage() - $customers->perPage();
               @endphp
